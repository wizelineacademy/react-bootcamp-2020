const videos = {
  ...
  etag: '5u7kNhlz5r_lM6JYVokysbAHLyA',
  ...
  items: [
    {
      ...
      etag: '2H9RWzqG3rk7QcBzdOLwPpsIRW4',
      id: {
    ...
    },
    {
      ...
      snippet: {
        ...
        channelId: 'UCPGzT4wecuWM0BH9mPiulXg',
        title: 'Spotlight: Meet the Wizeline Mexico Team (We are Hiring!)',
        description:
...
export const channels = {
  ...
  etag: 'x2bcJTRMfSG37GiebuuIa_Q770A',
  pageInfo: {
    totalResults: 1,
    resultsPerPage: 5,
  },
  items: [
    {
      kind: 'youtube#channel',
      etag: 'Oe4x9p3LqNBcynzCu_CvuESdO8A',
