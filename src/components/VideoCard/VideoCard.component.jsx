...
import { Card, CardContainer, CardImage, CardContent, Title, Description } from "./styles/VideoCard.styles";
import { CardSmall, CardContainerSmall, CardImageSmall, CardContentSmall, TitleSmall } from "./styles/VideoCardSmall.styles";

import { VIDEO_CARD_DEFAULT_SIZE } from "../../utils/constants";
import { ThemeContext } from 'styled-components';
import { useHistory } from 'react-router';

export default function VideoCard({ video: { snippet }, video: { id: { videoId: id } }, size = VIDEO_CARD_DEFAULT_SIZE }) {
